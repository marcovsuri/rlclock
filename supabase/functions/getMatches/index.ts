...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const seasonMatches = filterMatchesBySeason(matches, seasonStart); // Matches this season
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/getMatches' \
